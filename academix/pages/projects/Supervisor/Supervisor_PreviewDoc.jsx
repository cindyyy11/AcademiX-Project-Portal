...
import Supervisor_Timeline_5FinalDocumentation from "./timeline/5FinalDocumentation";

/** @param {{ onClose?: () => void }} props */
export default function SupervisorPreviewDoc(props) {
  useEffect(() => {
      ...
      <dialog id="my_modal_4" className="dui-modal">
        <div className="dui-modal-box w-11/12 max-w-5xl">
          ...
          <div style={{ maxHeight: "100%", overflowY: "auto" }}>
            <Supervisor_Timeline_5FinalDocumentation />
          </div>
