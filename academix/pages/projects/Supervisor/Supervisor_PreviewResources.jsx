...
import Supervisor_Timeline_2SuggestedResources from "./timeline/2SuggestedResources";

/** @param {{ onClose?: () => void }} props */
export default function SupervisorPreviewResource(props) {
  useEffect(() => {
    ...
    <>
      <dialog id="my_modal_4" className="dui-modal">
        <div className="dui-modal-box w-11/12 max-w-5xl">
          <h3 className="font-bold text-2xl h-full flex flex-col justify-center items-center mb-5">
            <FontAwesomeIcon icon={faEye} className="w-6 h-6" />
          </h3>
          <div style={{ maxHeight: "100%", overflowY: "auto" }}>
            <Supervisor_Timeline_2SuggestedResources />
          </div>
