...
const Supervisor_Timeline_Header: React.FC = () => {
    ...
    <div className={styles.timeline}>
      <div className={styles.timelineMiddle}>
        ...
        <nav className={styles.timelineMiddle2}>
          ...
          <CustomLink href={`/projects/Supervisor/projectdetails?id=${id}`}>
            <button className={styles.timelineNav2}>Project Details</button>
          </CustomLink>
          <CustomLink href={`/projects/Supervisor/projectmembers?id=${id}`}>
...
const CustomLink: React.FC<CustomLinkProps> = ({
  ...
  const router = useRouter();
  const isActive = router.pathname.startsWith(href) || (href.startsWith("/projects/Supervisor/timeline") && router.pathname.startsWith("/projects/Supervisor/timeline")) || (href.startsWith("/projects/Supervisor/projectdetails") && router.pathname.startsWith("/projects/Supervisor/projectdetails")) || (href.startsWith("/projects/Supervisor/projectmembers") && router.pathname.startsWith("/projects/Supervisor/projectmembers"));
...
export default Supervisor_Timeline_Header;
