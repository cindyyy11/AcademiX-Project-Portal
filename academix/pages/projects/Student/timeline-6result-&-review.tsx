...
const Student_Timeline_6ResultAndReview = () => {
  ...
  const resultData = [
    { name: "Proposal (20%)", DeductedMarks: 100 - grade.proposalMarks, YourMarks: grade.proposalMarks, amt: 2400 },
    { name: "Final Documentation (40%)", DeductedMarks: 100 -grade.finalDocumentationMarks, YourMarks: grade.finalDocumentationMarks, amt: 2210 },
    {
          ...
          >
            <div className={styles.timelineMiddle3}>
              ...
              <Link href="">
                <button
                  ...
                  onClick={() =>
                    setResultReviewCompleted(!resultReviewCompleted)
                  }
                >
                  Mark As Completed
                </button>
            ...
            <div className={styles.timelineMiddle4}>
              <div className={styles.timelineSectionDescription}>
                Results & Review is where you present the findings and outcomes
                of your work. This part should provide a clear, concise, and
                logical presentation of your data, analyses, and observations.
                It often includes visual aids such as charts, graphs, and tables
                to effectively communicate the results. The goal is to
                illustrate the key findings without interpretation or bias,
                laying the groundwork for the subsequent discussion and
                conclusion sections. This section demonstrates the success and
                validity of your project, highlighting how the data supports
                your initial hypothesis or project goals.
              </div>
            </div>
            ...
            <div className={styles.timelineMiddle6}>
              ...
              <p>
                ...
                in, accusamus, repudiandae quae iure debitis animi quisquam
                labore ab itaque suscipit. Perspiciatis iste ut excepturi amet
                magnam atque repellat rem.
              </p>
              <div className={styles.timelineMiddleX}>
                <a href={grade.resultTranscripts} download="Result Transcripts" target="_blank" className={styles.downloadBtn}>
                  Download&nbsp;
            ...
            <div className={styles.completeButtonWrapper}>
              <Link href="timeline-5final-documentation">
                <button className={styles.backBtn}>Back</button>
              </Link>
              <Link href="timeline-7feedback">
...
export default Student_Timeline_6ResultAndReview;
