...
import FeatImage02 from '@/public/images/SupervisorSettingUpProject.png'
import FeatImage03 from '@/public/images/ProjectTimeline-4Planning.png'
      ...
      <div className="max-w-6xl mx-auto px-4 land-sm:px-6">
        <div className="py-12 land-md:py-20 border-t border-n-1 dark:border-white">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 land-md:pb-16">
            ...
            <p className="text-xl text-n-3 dark:text-white/75">One platform, countless possibilities: AcademiX is your all-in-one solution for final year project management. Designed to streamline and simplify every step of the project lifecycle, AcademiX empowers students and educators with robust tools for planning, collaboration, and execution. From ideation to final presentation, our platform ensures that every milestone is met with precision and efficiency, paving the way for academic success and innovation.</p>
          </div>
          ...
          <div className="grid gap-20">
            ...
            {/* 1st item */}
            <div className="land-md:grid land-md:grid-cols-12 land-md:gap-6 items-center">
              {/* Image */}
              <div className="max-w-xl land-md:max-w-none land-md:w-full mx-auto land-md:col-span-5 land-lg:col-span-6 mb-8 land-md:mb-0 land-md:order-1" data-aos="fade-up">
                <Image className="max-w-full mx-auto land-md:max-w-none h-auto" src={FeatImage01} width={540} height={405} alt="Features 01" />
              </div>
              {/* Content */}
            ...
            <div className="land-md:grid land-md:grid-cols-12 land-md:gap-6 items-center">
              {/* Image */}
              <div className="max-w-xl land-md:max-w-none land-md:w-full mx-auto land-md:col-span-5 land-lg:col-span-6 mb-8 land-md:mb-0 rtl" data-aos="fade-up">
                <Image className="max-w-full mx-auto land-md:max-w-none h-auto" src={FeatImage02} width={540} height={405} alt="Features 02" />
              </div>
              {/* Content */}
            ...
            <div className="land-md:grid land-md:grid-cols-12 land-md:gap-6 items-center">
              {/* Image */}
              <div className="max-w-xl land-md:max-w-none land-md:w-full mx-auto land-md:col-span-5 land-lg:col-span-6 mb-8 land-md:mb-0 land-md:order-1" data-aos="fade-up">
                <Image className="max-w-full mx-auto land-md:max-w-none h-auto" src={FeatImage03} width={540} height={405} alt="Features 03" />
              </div>
              {/* Content */}
              <div className="max-w-xl land-md:max-w-none land-md:w-full mx-auto land-md:col-span-7 land-lg:col-span-6" data-aos="fade-right">
                <div className="land-md:pr-4 land-lg:pr-12 land-xl:pr-16">
